<%@ Page Title="" Language="C#" MasterPageFile="~/EmpMaster.Master" AutoEventWireup="true" CodeBehind="JobSeekLogin.aspx.cs" Inherits="EmpPortal.JobSeekLogin" %>
     ...
     <div class="header">
            <table class="headerTable">
                         ...
                         <tr>
                                ...
                                <td>
                        <asp:Button ID="btnLogin" runat="server" Text="Log In" OnClick="btnLogin_Click" CssClass="btnStyle" CausesValidation="false"  style="font-family:Verdana; font-size:18pt; font-size:normal;" ForeColor="#003399" />
                    </td>
